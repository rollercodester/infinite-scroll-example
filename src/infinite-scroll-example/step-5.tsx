...
export function InfiniteScrollExample() {
  ...
  // let's add state to track when to disable/enable infinite scroll
  const [disableScroll, setDisableScroll] = useState(false);
  // let's use that state in our useInfiniteScroll hook
  ...
  // let's add a handler to disable infinite scroll
  ...
  return (
    <div className={classes.rootContainer}>
      ...
      <div className={classes.toolbar}>
        ...
        {/* let's add our handler to the button and streamline the text */}
